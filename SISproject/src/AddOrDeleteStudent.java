...
public class AddOrDeleteStudent
	...
	Students.database.add(new Students(firstName, lastName,Period1,class1, grade1,Period2, class2, grade2, Period3, class3, grade3, GPA));
	
	makeGPA.createGPA();
	System.out.println(Students.database);
	//+ "\n" + firstName + " " + lastName + " " + Period1 + "" + class1 + " " + grade1 + " " + Period2 + " " + class2 + " " + grade2 + Period3 + " " + " " + class3 + " " + grade3);
